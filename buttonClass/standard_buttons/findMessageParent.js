...
import { GEOGRAPHIC_TYPES_ORDER } from "spinal-env-viewer-context-geographic-service";

import { SpinalContextSelectBIMObject } from "spinal-env-viewer-plugin-standard_button/js/selectBIMObjectButton";

import { SpinalContextFitToViewer } from "spinal-env-viewer-plugin-standard_button/js/fitToViewerButton";
...
class FindMessageParent extends SpinalContextApp {
	...
	isShown(option) {
		...
		return contextType === `${NOTE_TYPE}GroupContext` ? Promise.resolve(true) : Promise.resolve(-1);
	}
