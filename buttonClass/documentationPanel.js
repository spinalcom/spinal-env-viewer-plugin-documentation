...
//                                Right click Panel                                     //
////////////////////////////////////////////////////////////////////////////////////////////////////
export const addAutoUrlRightClick = SpinalForgeExtention.createExtention({
...
export const deleteAutoUrlRightClick = SpinalForgeExtention.createExtention({
				...
				if (status.hasSelected) {
					menu.push({
						...
						target: () => {
							...
							forgeTree.getAllCategoryByDbidArray(allChildDbid).then((mycat) => {
								const propsData = {
									dbid: allChildDbid,
									category: mycat,
								};
